      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen p-8">
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-6">
              <motion.div
                ...
                className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-blue-100 to-purple-100 text-blue-800 text-sm font-medium"
              >
              ...
              <motion.h1
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.3, duration: 0.6 }}
                className="text-5xl lg:text-7xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-purple-900 bg-clip-text text-transparent leading-tight"
              >
                Write Together,
                <br />
                Create Magic
            ...
            >
              {[
                ...
                <motion.div
                  ...
                  className="p-4 rounded-2xl bg-white/60 backdrop-blur-sm border border-white/20 shadow-lg hover:shadow-xl transition-all duration-300"
                >
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative p-8 rounded-3xl bg-white/80 backdrop-blur-xl border border-white/20 shadow-2xl">
              <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-white/40 to-white/10 backdrop-blur-xl"></div>
...
function Header() {
  return (
    <motion.header
      ...
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 0.6 }}
      className="bg-white/80 backdrop-blur-xl border-b border-white/20 px-6 py-4 flex justify-between items-center shadow-sm"
    >
  ...
  return (
    <div className="text-center max-w-md mx-auto p-8">
      <motion.div
        ...
        className="w-24 h-24 mx-auto mb-6 rounded-full bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center"
      >
